...
output_file_name = "d7_Completeness_IG_5 _with_4%.txt" # mems rename
...
with open(output_file_name, "a") as f:
     ...
     print(p, file=f)
     print('Number of gafgyt_tcp_samples that changed classification: ',p[0], file=f)
     print('Number of all samples analyzed: ',p[1], file=f)
     print(percentage,'%','- samples are complete ',file=f)

# worked with 5 samples.. took about 20 mins.. with the subset dataset